...
- [ ] Stocker le bind et le jeton sur l’instance retournée par `build_server`, puis les lire depuis `self.server` dans `_guard_mutation`.
- [ ] Construire simultanément un serveur loopback sans jeton et un serveur réseau avec jeton; prouver que leurs politiques restent isolées.
