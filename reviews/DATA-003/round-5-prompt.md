...
ARTEFACT — .superpowers/sdd/DATA-003/review-2ed262e..d4d85d4.diff :
# Review package: 2ed262e2c31a311134ff63c1336e50ddb23d0555..d4d85d4ac9b18f41686e7622e2a967754d7d4f86
...
## Files changed
 src/forgeai/bootstrap/secrets.py   | 258 ++++++++++++--
 src/forgeai/deploy/openbao_flow.py |   5 +-
 src/forgeai/models/vault.py        |  59 +++-
 tests/test_assemble_and_secrets.py | 707 ++++++++++++++++++++++++++++++++++++-
 tests/test_openbao_flow.py         | 188 +++++++++-
 tests/test_vault.py                |  25 +-
 6 files changed, 1201 insertions(+), 41 deletions(-)

## Diff
diff --git a/src/forgeai/bootstrap/secrets.py b/src/forgeai/bootstrap/secrets.py
index 75f371b..9ae32d8 100644
...
@@ -35,31 +44,717 @@ def test_gpu_seulement_si_profil_cuda_et_service_capable():
