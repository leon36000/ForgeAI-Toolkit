...
ARTEFACT — .superpowers/sdd/DATA-003/review-2ed262e..01a418d.diff :
# Review package: 2ed262e2c31a311134ff63c1336e50ddb23d0555..01a418d9d22049bc9cd8a81de0ed16050196c304

## Commits
01a418d [DATA-003] Sécuriser les parents des stores OpenBao
c150580 [DATA-003] Durcir le coffre et les répertoires imbriqués
d4d85d4 [DATA-003] Expliciter les branches de sécurité
2986409 [DATA-003] Supporter les umasks restrictifs
c455660 [DATA-003] Durcir les chemins du bootstrap secret
...
## Files changed
 ...
 tests/test_openbao_flow.py         | 542 ++++++++++++++++++++++++-
 tests/test_vault.py                | 169 +++++++-
 6 files changed, 1816 insertions(+), 57 deletions(-)
...
@@ -68,38 +130,510 @@ def test_file_key_store_write_read_and_root_isolation(tmp_path) -> None:
