...
ARTEFACT — /Users/nathanst-louis/Documents/Codex/2026-07-25/e/work/worktrees/DATA-003/.superpowers/sdd/DATA-003/review-2ed262e..1970c46.diff :
# Review package: 2ed262e2c31a311134ff63c1336e50ddb23d0555..1970c46

## Commits
1970c46 [DATA-003] Sécuriser les écritures atomiques de secrets

## Files changed
 src/forgeai/bootstrap/secrets.py   |  14 ++-
 src/forgeai/deploy/openbao_flow.py |   5 +-
 src/forgeai/models/vault.py        |  17 +++-
 tests/test_assemble_and_secrets.py |  19 +++-
 tests/test_openbao_flow.py         | 188 ++++++++++++++++++++++++++++++++++++-
 tests/test_vault.py                |  21 +++++
...
index 75f371b..bf3c8f1 100644
--- a/src/forgeai/bootstrap/secrets.py
+++ b/src/forgeai/bootstrap/secrets.py
@@ -4,20 +4,22 @@ Génère les secrets d'exécution (jetons aléatoires 256 bits) dans <out>/.env
...
@@ -39,19 +41,23 @@ def bootstrap_secrets(out_dir: Path, regen: bool = False) -> dict[str, Path]:
...
@@ -56,10 +58,25 @@ def test_secrets_generes_permissions_0600(tmp_path):
...
@@ -99,10 +102,28 @@ def test_mauvais_token_leve_vaulterror(bao):
