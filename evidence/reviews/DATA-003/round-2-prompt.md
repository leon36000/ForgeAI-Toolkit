...
ARTEFACT — /Users/nathanst-louis/Documents/Codex/2026-07-25/e/work/worktrees/DATA-003/.superpowers/sdd/DATA-003/review-2ed262e..641186e.diff :
# Review package: 2ed262e2c31a311134ff63c1336e50ddb23d0555..641186e32797e79eb8e4bf462fb2771787affa90
...
## Files changed
 src/forgeai/bootstrap/secrets.py   |  22 ++++-
 src/forgeai/deploy/openbao_flow.py |   5 +-
 src/forgeai/models/vault.py        |  38 +++++++-
 tests/test_assemble_and_secrets.py | 139 +++++++++++++++++++++++++--
 tests/test_openbao_flow.py         | 188 ++++++++++++++++++++++++++++++++++++-
 tests/test_vault.py                |  25 ++++-
 6 files changed, 397 insertions(+), 20 deletions(-)

## Diff
diff --git a/src/forgeai/bootstrap/secrets.py b/src/forgeai/bootstrap/secrets.py
index 75f371b..86ed270 100644
--- a/src/forgeai/bootstrap/secrets.py
+++ b/src/forgeai/bootstrap/secrets.py
@@ -4,20 +4,25 @@ Génère les secrets d'exécution (jetons aléatoires 256 bits) dans <out>/.env
...
@@ -39,19 +44,26 @@ def bootstrap_secrets(out_dir: Path, regen: bool = False) -> dict[str, Path]:
...
@@ -35,31 +40,153 @@ def test_gpu_seulement_si_profil_cuda_et_service_capable():
